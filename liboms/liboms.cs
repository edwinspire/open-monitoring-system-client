...
namespace OpenMonitoringSystem
{
	...
	namespace Client{
		...
		public abstract class Comunicator{
			...
			public abstract EventData getEvent(bool force_get_remote_config = true);
